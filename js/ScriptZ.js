    ...
    jQ.extend({
        ...
        jackpot : {
            ...
            set_data: function(){
                ...
                //         $.jackpot.current = parseInt(data.currentValue);
                //         $.jackpot.difference = parseInt(data.difference);
                //         //$(".money").data('currentvalue', data.currentValue);
                //         //$(".money").data('difference', data.difference);
                //     }
                // });
            },
            running:function(){
                setInterval(function(){
                    $.jackpot.dom.each(function(){
                        ...
                        $(this).text(
                            "¥" + ($.jackpot.current/100).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')
                        );
                    });
                },$.jackpot.speed);
            },
        ...
        winner :{
            ...
            drawing : function(item){
                if ( typeof item  != "undefined"){
                    ...
                    obj.children(".plat").text(obj.children(".plat").text().split("：")[0] + "：" + item.gamePaltform);
...
/*安全性設定*/
    ...
    $(function () {
        ...
        $("#Account .item , #Support .item, #News .item").click(function () {
